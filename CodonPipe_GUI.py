...
CODONPIPE_GUI_BUILD = "direct-decoding-v35-pair-gap-labels-2026-05-24"
...
class CodonPipeGUI:
    ...
    def _build_variables(self):
        ...
        self.decoding_clusters_selection = []  # Default: no cluster-level decoding clusters selected until user picks them
        ...
        self.trna_modifications_plot_kind = tk.StringVar(value=str(S.get("trna_modifications_plot_kind", "heatmap") or "heatmap"))
        ...
        self.trna_modifications_boxplot_caption_size = tk.StringVar(value=str(S.get("trna_modifications_boxplot_caption_size", 13)))
        ...
        self.trna_supp_heatmaps_dpi = tk.StringVar(value=str(S.get("trna_supp_heatmaps_dpi", "") or ""))
        self.trna_supp_heatmaps_fig_width = tk.StringVar(value=str(S.get("trna_supp_heatmaps_fig_width", "") or ""))
        self.trna_supp_heatmaps_fig_height = tk.StringVar(value=str(S.get("trna_supp_heatmaps_fig_height", "") or ""))
        self.trna_supp_heatmaps_cell_height = tk.StringVar(value=str(S.get("trna_supp_heatmaps_cell_height", "") or ""))
        self.trna_supp_heatmaps_xtick_every_genes = tk.StringVar(value=str(S.get("trna_supp_heatmaps_xtick_every_genes", "") or ""))
        self.trna_supp_heatmaps_ytick_fontsize = tk.StringVar(value=str(S.get("trna_supp_heatmaps_ytick_fontsize", "") or ""))
        self.trna_supp_heatmaps_title_fontsize = tk.StringVar(value=str(S.get("trna_supp_heatmaps_title_fontsize", "") or ""))
        ...
        self.trna_shift_heatmaps_dpi = tk.StringVar(value=str(S.get("trna_shift_heatmaps_dpi", "") or ""))
        self.trna_shift_heatmaps_fig_width = tk.StringVar(value=str(S.get("trna_shift_heatmaps_fig_width", "") or ""))
        self.trna_shift_heatmaps_fig_height = tk.StringVar(value=str(S.get("trna_shift_heatmaps_fig_height", "") or ""))
        self.trna_shift_heatmaps_cell_width = tk.StringVar(value=str(S.get("trna_shift_heatmaps_cell_width", "") or ""))
        self.trna_shift_heatmaps_cell_height = tk.StringVar(value=str(S.get("trna_shift_heatmaps_cell_height", "") or ""))
        self.trna_shift_heatmaps_xtick_fontsize = tk.StringVar(value=str(S.get("trna_shift_heatmaps_xtick_fontsize", "") or ""))
        self.trna_shift_heatmaps_ytick_fontsize = tk.StringVar(value=str(S.get("trna_shift_heatmaps_ytick_fontsize", "") or ""))
        self.trna_shift_heatmaps_title_fontsize = tk.StringVar(value=str(S.get("trna_shift_heatmaps_title_fontsize", "") or ""))
    ...
    def _build_plots_details_tab(self, parent):
        ...
        self._add_labeled_widget(self.trna_gene_heatmap_custom_content, 0, 0, "DPI", ttk.Entry(self.trna_gene_heatmap_custom_content, textvariable=self.trna_supp_heatmaps_dpi, width=12), "Optional saved resolution for gene-ordered heatmaps 1 and 2. Leave blank to keep the standard figure DPI.")
        self._add_labeled_widget(self.trna_gene_heatmap_custom_content, 0, 2, "Figure width (in)", ttk.Entry(self.trna_gene_heatmap_custom_content, textvariable=self.trna_supp_heatmaps_fig_width, width=12), "Optional width for gene-ordered heatmaps 1 and 2. Leave blank to keep the main codon-heatmap width.")
        ...
        self._add_labeled_widget(self.trna_gene_heatmap_custom_content, 0, 4, "Figure height (in)", self.trna_supp_fig_height_entry, "Optional absolute height for gene-ordered heatmaps 1 and 2. Leave blank to derive height from the cell-height setting.")
        ...
        self._add_labeled_widget(self.trna_gene_heatmap_custom_content, 1, 0, "Cell height (relative)", self.trna_supp_cell_height_entry, "Relative row height for gene-ordered heatmaps 1 and 2. A value of 1 matches the row height of the main gene×codon heatmap from the Figures tab. Leave blank to let figure height control the plot.")
        ...
        self.trna_secondary_axis_details_content.grid(row=5, column=0, columnspan=6, sticky="ew", pady=(10, 2))
        for c in range(6):
    ...
    def _build_trna_tab(self, parent):
        ...
        ttk.Label(
            ...
            text="Cluster-level enrichment of codons requiring tRNA modifications or tRNA-modification enzymes listed in columns 6–7 of the decoding table.",
            foreground="#444444",
            wraplength=820,
        ).grid(row=0, column=0, columnspan=5, sticky="w", pady=(0, 4))
        self._add_labeled_widget(
        ...
        self._add_labeled_widget(self.trna_modification_box, 2, 2, "Y min", ttk.Entry(self.trna_modification_box, textvariable=self.trna_modifications_boxplot_ymin, width=8), "Optional boxplot/violin y-axis minimum for plot 6.")
        self._add_labeled_widget(self.trna_modification_box, 2, 4, "Y max", ttk.Entry(self.trna_modification_box, textvariable=self.trna_modifications_boxplot_ymax, width=8), "Optional boxplot/violin y-axis maximum for plot 6.")
    ...
    def _browse_trna_decoding_table(self):
        ...
        if path:
            ...
            try:
                xls = pd.ExcelFile(path)
                if xls.sheet_names:
                    self.trna_decoding_table_sheet.set(xls.sheet_names[0])
...
"""
    ...
    def _apply_default_settings(self):
        ...
        self.trna_modifications_plot_kind.set(str(CP.SET.get("trna_modifications_plot_kind", "heatmap") or "heatmap"))
        ...
        self.trna_supp_heatmaps_dpi.set(str(CP.SET.get("trna_supp_heatmaps_dpi", "") or ""))
        self.trna_supp_heatmaps_fig_width.set(str(CP.SET.get("trna_supp_heatmaps_fig_width", "") or ""))
        self.trna_supp_heatmaps_fig_height.set(str(CP.SET.get("trna_supp_heatmaps_fig_height", "") or ""))
        self.trna_supp_heatmaps_cell_height.set(str(CP.SET.get("trna_supp_heatmaps_cell_height", "") or ""))
        self.trna_supp_heatmaps_xtick_every_genes.set(str(CP.SET.get("trna_supp_heatmaps_xtick_every_genes", "") or ""))
        self.trna_supp_heatmaps_ytick_fontsize.set(str(CP.SET.get("trna_supp_heatmaps_ytick_fontsize", "") or ""))
        self.trna_supp_heatmaps_title_fontsize.set(str(CP.SET.get("trna_supp_heatmaps_title_fontsize", "") or ""))
        ...
        self.trna_shift_heatmaps_dpi.set(str(CP.SET.get("trna_shift_heatmaps_dpi", "") or ""))
        self.trna_shift_heatmaps_fig_width.set(str(CP.SET.get("trna_shift_heatmaps_fig_width", "") or ""))
        self.trna_shift_heatmaps_fig_height.set(str(CP.SET.get("trna_shift_heatmaps_fig_height", "") or ""))
        self.trna_shift_heatmaps_cell_width.set(str(CP.SET.get("trna_shift_heatmaps_cell_width", "") or ""))
        self.trna_shift_heatmaps_cell_height.set(str(CP.SET.get("trna_shift_heatmaps_cell_height", "") or ""))
        self.trna_shift_heatmaps_xtick_fontsize.set(str(CP.SET.get("trna_shift_heatmaps_xtick_fontsize", "") or ""))
        self.trna_shift_heatmaps_ytick_fontsize.set(str(CP.SET.get("trna_shift_heatmaps_ytick_fontsize", "") or ""))
        self.trna_shift_heatmaps_title_fontsize.set(str(CP.SET.get("trna_shift_heatmaps_title_fontsize", "") or ""))
    ...
    def _collect_set_overrides(self):
        ...
        S["trna_modifications_boxplot_caption_size"] = _safe_int(self.trna_modifications_boxplot_caption_size.get(), 13)
        ...
        S["trna_modifications_plot_kind"] = str(self.trna_modifications_plot_kind.get() or "heatmap").strip().lower()
        ...
        S["trna_shift_heatmaps_fig_width"] = _safe_float(self.trna_shift_heatmaps_fig_width.get(), 8.0) if trna_shift_custom and self.trna_shift_heatmaps_fig_width.get().strip() else None
        ...
        S["trna_shift_heatmaps_fig_height"] = _safe_float(self.trna_shift_heatmaps_fig_height.get(), 6.0) if trna_shift_custom and self.trna_shift_heatmaps_fig_height.get().strip() else None
        ...
        S["trna_shift_heatmaps_cell_width"] = _safe_float(self.trna_shift_heatmaps_cell_width.get(), 0.8) if trna_shift_custom and self.trna_shift_heatmaps_cell_width.get().strip() else None
        ...
        if S["trna_shift_heatmaps_fig_width"] is not None:
            S["trna_shift_heatmaps_cell_width"] = None
        S["trna_shift_heatmaps_cell_height"] = _safe_float(self.trna_shift_heatmaps_cell_height.get(), 1.5) if trna_shift_custom and self.trna_shift_heatmaps_cell_height.get().strip() else None
        ...
        if S["trna_shift_heatmaps_fig_height"] is not None:
            S["trna_shift_heatmaps_cell_height"] = None
        S["trna_shift_heatmaps_xtick_fontsize"] = _safe_int(self.trna_shift_heatmaps_xtick_fontsize.get(), 10) if trna_shift_custom and self.trna_shift_heatmaps_xtick_fontsize.get().strip() else None
        S["trna_shift_heatmaps_ytick_fontsize"] = _safe_int(self.trna_shift_heatmaps_ytick_fontsize.get(), 10) if trna_shift_custom and self.trna_shift_heatmaps_ytick_fontsize.get().strip() else None
        S["trna_shift_heatmaps_title_fontsize"] = _safe_int(self.trna_shift_heatmaps_title_fontsize.get(), 12) if trna_shift_custom and self.trna_shift_heatmaps_title_fontsize.get().strip() else None
